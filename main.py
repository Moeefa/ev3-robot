...
from structures import Robot, Claw
...
claw = test_port(Claw, Port.D, positive_direction=Direction.COUNTERCLOCKWISE)
door = test_port(Motor, Port.C)
wheel_diameter = 32 # mm
axle_track = 190 # mm
robot = Robot(left_motor, right_motor, wheel_diameter, axle_track, sensor_left, sensor_right, ir_sensor)

# Constants for the PID configuration
KP = 3.5  # Proportional gain
KI = 0.0005  # Integral gain
KD = 0.01  # Derivative gain
robot.configure(KP, KI, KD)
